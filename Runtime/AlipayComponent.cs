...
namespace GameFrameX.Payment.Alipay.Runtime
{
    ...
    [AddComponentMenu("GameFrameX/Alipay Payment")]
    [RequireComponent(typeof(GameFrameXAlipayCroppingHelper))]
    [UnityEngine.Scripting.Preserve]
    public partial class AlipayComponent : GameFrameworkComponent
    {
        private IAlipayManager _alipayManager = null;

        public string m_AppId;
        public bool m_IsSandbox;
        ...
        {
            ImplementationComponentType = typeof(AlipayManager);
            ...
            {
                Log.Fatal("Alipay manager is invalid.");
                return;
            }
